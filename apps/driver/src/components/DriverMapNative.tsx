...
import { mapTilerDarkStyleUrl } from '../lib/mapStyle';
import type { DriverMapHandle, DriverMapProps } from './DriverMap';

type Props = DriverMapProps;

const FALLBACK_CENTER: [number, number] = [152.855, -25.288]; // Hervey Bay area

/** Only load this module when MapLibre native TurboModules are registered. */
export const DriverMapNative = forwardRef<DriverMapHandle, Props>(function DriverMapNative(
